Delhivery Tracking API - PHP
================================
Use PHP to track Delhivery shipments with Delhivery Tracking API.
...
Create a tracking (Real-time tracking):
      ...
      try {
        $params = ['tracking_number'=>'1091316924516','courier_code'=>'delhivery'];
...
Create trackings (Max. 40 tracking numbers create in one call):
        ...
        try {
            $params = [
                ...
                ['tracking_number'=>'1178411767065','courier_code'=>'delhivery']
            ];
...
Get status of the shipment:
    ...
    try {
        $params = ['courier_code'=>'delhivery','created_date_min'=>'2023-08-23T06:00:00+00:00','created_date_max'=>'2023-09-05T07:20:42+00:00'];
