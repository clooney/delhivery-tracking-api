Delhivery Tracking API - Java
================================
Use Java to track Delhivery shipments with Delhivery Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.delhivery;
    ...
    public class CreateDelhiveryTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("1091316924516");
                createTrackingParams.setCourierCode("delhivery");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateDelhiveryTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setCourierCode("delhivery");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("92642903289511563030094932");
                createTrackingParams2.setCourierCode("delhivery");
...
Get status of the shipment:
    ...
    public class GetDelhiveryTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("5552616384490,1178411767065");
                trackingParams.setCourierCode("delhivery");
...
Update a tracking by ID:
    ...
    public class UpdateDelhiveryTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "98d15957af8c0a39e23c1d237ba45876";
